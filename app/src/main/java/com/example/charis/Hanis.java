...
public class Hanis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hanis);
    ...
    public void add_to_list(View view) {
        if (view == findViewById(R.id.checkBox)) {
            choices = choices + "Cheese Burger" + "\n";
            price = price + 6000;

        } else if (view == findViewById(R.id.checkBox1)) {
            choices = choices + "Francisco Sandwich" + "\n";
            price = price + 7000;

        } else if (view == findViewById(R.id.checkBox2)) {
            choices = choices + "Meat Shawarma" + "\n";
            price = price + 5000;
