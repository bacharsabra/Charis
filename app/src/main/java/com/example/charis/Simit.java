...
public class Simit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simit);
    ...
    public void add_to_list(View view) {
        if (view == findViewById(R.id.checkBox)) {
            choices = choices + "Plain Simit" + "\n";
            price = price + 5000;

        } else if (view == findViewById(R.id.checkBox1)) {
            choices = choices + "Cheddar Simit" + "\n";
            price = price + 5500;

        } else if (view == findViewById(R.id.checkBox2)) {
            choices = choices + "Chia Simit" + "\n";
            price = price + 7000;
